...
impl RawExecutionV3 {
    ...
    where
        E: ExecutionEncoder,
    {
        // Collect main transaction hash data
        let mut data = vec![
            PREFIX_INVOKE,
            if query_only {
                QUERY_VERSION_THREE
    ...
    A: ConnectedAccount,
{
    ...
    async fn get_invoke_request(
        ...
        query_only: bool,
        skip_signature: bool,
    ) -> Result<InvokeTxnV1, A::SignError> {
        Ok(InvokeTxnV1 {
    ...
    A: ConnectedAccount,
{
    ...
    async fn get_invoke_request(
        ...
        query_only: bool,
        skip_signature: bool,
    ) -> Result<InvokeTxnV3, A::SignError> {
        Ok(InvokeTxnV3 {
