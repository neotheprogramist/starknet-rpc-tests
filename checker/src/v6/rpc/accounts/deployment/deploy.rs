...
use starknet_types_rpc::v0_6_0::{BlockId, BlockTag, TxnHash};
...
use super::{
    helpers::{get_contract_address, get_deployment_result, get_deployment_result_v3},
    structs::WaitForTx,
};
...
pub async fn deploy_account_v3(
    provider: &JsonRpcClient<HttpTransport>,
    chain_id: Felt,
    wait_config: WaitForTx,
    account_data: GenerateAccountResponse,
