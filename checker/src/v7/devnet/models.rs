use std::{net::IpAddr, num::NonZeroU128, str::FromStr};

use num_bigint::BigUint;
use serde::{Deserialize, Deserializer, Serialize};
use starknet_types_core::felt::Felt;
use starknet_types_rpc::{v0_7_1::PriceUnit, BlockHash, MsgToL1, TxnHash};
use url::Url;
...
pub struct SetTimeResponse {
    ...
    pub block_hash: Option<BlockHash<Felt>>,
}
...
pub struct AbortBlocksParams {
    pub starting_block_hash: BlockHash<Felt>,
}

#[derive(Debug, Clone, Eq, PartialEq, Serialize, Deserialize)]
pub struct AbortBlocksResponse {
    pub aborted: Vec<BlockHash<Felt>>,
}
...
pub struct PostmanFlushResponse {
    pub messages_to_l1: Vec<MsgToL1<Felt>>,
    pub messages_to_l2: Vec<MsgToL2<Felt>>,
    pub generated_l2_transactions: Vec<TxnHash<Felt>>,
    pub l1_provider: String,
}

#[derive(Debug, Clone, Eq, PartialEq, Deserialize, Serialize)]
pub struct MsgToL2<T> {
    pub l2_contract_address: T,
    pub entry_point_selector: T,
    pub l1_contract_address: T,
    pub payload: Vec<T>,
    pub paid_fee_on_l1: T,
    pub nonce: T,
}

#[derive(Debug, Clone, Eq, PartialEq, Serialize, Deserialize)]
pub struct PostmanSendMessageToL2Response {
    pub transaction_hash: TxnHash<Felt>,
}
