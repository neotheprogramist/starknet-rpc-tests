...
pub fn verify_invoke_v1_signature(txn: &InvokeTxnV1<Felt>, public_key: &str, chain_id_input: &str) -> Result<(bool, Felt), VerifyError> {
...
pub fn verify_invoke_v3_signature(txn: &InvokeTxnV3<Felt>, public_key: &str, chain_id_input: &str) -> Result<(bool, Felt), VerifyError> {
    let chain_id = Felt::from_hex_unchecked(chain_id_input);
